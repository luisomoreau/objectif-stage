        ...
        <h3>Recherche</h3>
            <form action="listestages" method="GET" id="recherche">
                <div class="col_12 float_l">
            		<input placeholder="Mots-clés" type="text" name="champ_rech" id="champ_rech" maxlength="100" value="<?php echo $_GET[champ_rech]; ?>" />
                ...
                <div class="col_12 float_r"> 
                    ...
                    <select name="licenceEtud">
                        ...
                        <option <?php if($_GET[licenceEtud]==="Stage L2") { echo 'selected="selected"';}?>>Stage L2</option>
                        <option <?php if($_GET[licenceEtud]==="Stage L3") { echo 'selected="selected"';}?>>Stage L3</option>
                        <option <?php if($_GET[licenceEtud]==="Projet Tuteuré") { echo 'selected="selected"';}?>>Projet Tuteuré</option>
                    </select> 
                </div>
