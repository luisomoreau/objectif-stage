...
$stmt = $mysqli->prepare('SELECT idEnt, nomStage, prenomContactStage, nomContactStage, lieuStage, latStage, lngStage,
                            dateDebutStage, dateFinStage, dateLimiteStage, typeStage, sujetStage, detailsStage
...
?>
    ...
    <form action="majstagedb" method="POST">
        ...
        <div class="col_23 float_l">
            ...
            <div class="cleaner h10"></div>
            <input type="checkbox" name="htmlcssStage" id="htmlcssStage" value="1" <?php if ($htmlcssStage === "1") {
            ...
            <input type="checkbox" name="phpStage" id="phpStage" value="1"<?php if ($phpStage === "1") {
                echo 'checked="checked"';
            } ?>/>
            <label class="checkbox" for="phpStage">PHP</label>

            <input type="checkbox" name="sqlStage" id="sqlStage" value="1"<?php if ($sqlStage === "1") {
                echo 'checked="checked"';
            } ?>/>
            <label class="checkbox" for="sqlStage">SQL</label>

            <input type="checkbox" name="javaStage" id="javaStage" value="1"<?php if ($javaStage === "1") {
                echo 'checked="checked"';
            } ?>/>
            <label class="checkbox" for="javaStage">JAVA</label>

            <input type="checkbox" name="cStage" id="cStage" value="1"<?php if ($cStage === "1") {
                echo 'checked="checked"';
            } ?>/>
            <label class="checkbox" for="cStage">C</label>

            <input type="checkbox" name="csStage" id="csStage" value="1"<?php if ($csStage === "1") {
                echo 'checked="checked"';
            } ?>/>
            ...
            <textarea name="langageAutreStage" id="langageAutreStage" maxlength="255"><?php if ($langageAutreStage !== "NULL") {
                    echo $langageAutreStage;
                } ?></textarea>
        </div>
        ...
        <div class="col_13 float_r">
            ...
            <select name="dateMoisDebutStage">
                <option value="1"<?php if ($moisDebutStage === "01") {
                    echo 'selected="selected"';
                } ?>>Janvier
                </option>
                <option value="2"<?php if ($moisDebutStage === "02") {
                    echo 'selected="selected"';
                } ?>>Fevrier
                </option>
                <option value="3"<?php if ($moisDebutStage === "03") {
                    echo 'selected="selected"';
                } ?>>Mars
                </option>
                <option value="4"<?php if ($moisDebutStage === "04") {
                    echo 'selected="selected"';
                } ?>>Avril
                </option>
                <option value="5"<?php if ($moisDebutStage === "05") {
                    echo 'selected="selected"';
                } ?>>Mai
                </option>
                <option value="6"<?php if ($moisDebutStage === "06") {
                    echo 'selected="selected"';
                } ?>>Juin
                </option>
                <option value="7"<?php if ($moisDebutStage === "07") {
                    echo 'selected="selected"';
                } ?>>Juillet
                </option>
                <option value="8"<?php if ($moisDebutStage === "08") {
                    echo 'selected="selected"';
                } ?>>Août
                </option>
                <option value="9"<?php if ($moisDebutStage === "09") {
                    echo 'selected="selected"';
                } ?>>Septembre
                </option>
                <option value="10"<?php if ($moisDebutStage === "10") {
                    echo 'selected="selected"';
                } ?>>Octobre
                </option>
                <option value="11"<?php if ($moisDebutStage === "11") {
                    echo 'selected="selected"';
                } ?>>Novembre
                </option>
                <option value="12"<?php if ($moisDebutStage === "12") {
                    echo 'selected="selected"';
                } ?>>Décembre
                </option>
            </select>
            ...
            <select name="dateMoisFinStage">
                <option value="1"<?php if ($moisFinStage === "01") {
                    echo 'selected="selected"';
                } ?>>Janvier
                </option>
                <option value="2"<?php if ($moisFinStage === "02") {
                    echo 'selected="selected"';
                } ?>>Fevrier
                </option>
                <option value="3"<?php if ($moisFinStage === "03") {
                    echo 'selected="selected"';
                } ?>>Mars
                </option>
                <option value="4"<?php if ($moisFinStage === "04") {
                    echo 'selected="selected"';
                } ?>>Avril
                </option>
                <option value="5"<?php if ($moisFinStage === "05") {
                    echo 'selected="selected"';
                } ?>>Mai
                </option>
                <option value="6"<?php if ($moisFinStage === "06") {
                    echo 'selected="selected"';
                } ?>>Juin
                </option>
                <option value="7"<?php if ($moisFinStage === "07") {
                    echo 'selected="selected"';
                } ?>>Juillet
                </option>
                <option value="8"<?php if ($moisFinStage === "08") {
                    echo 'selected="selected"';
                } ?>>Août
                </option>
                <option value="9"<?php if ($moisFinStage === "09") {
                    echo 'selected="selected"';
                } ?>>Septembre
                </option>
                <option value="10"<?php if ($moisFinStage === "10") {
                    echo 'selected="selected"';
                } ?>>Octobre
                </option>
                <option value="11"<?php if ($moisFinStage === "11") {
                    echo 'selected="selected"';
                } ?>>Novembre
                </option>
                <option value="12"<?php if ($moisFinStage === "12") {
                    echo 'selected="selected"';
                } ?>>Décembre
                </option>
            </select>
            ...
            <select name="dateMoisLimiteStage">
                <option value="1"<?php if ($moisLimiteStage === "01") {
                    echo 'selected="selected"';
                } ?>>Janvier
                </option>
                <option value="2"<?php if ($moisLimiteStage === "02") {
                    echo 'selected="selected"';
                } ?>>Fevrier
                </option>
                <option value="3"<?php if ($moisLimiteStage === "03") {
                    echo 'selected="selected"';
                } ?>>Mars
                </option>
                <option value="4"<?php if ($moisLimiteStage === "04") {
                    echo 'selected="selected"';
                } ?>>Avril
                </option>
                <option value="5"<?php if ($moisLimiteStage === "05") {
                    echo 'selected="selected"';
                } ?>>Mai
                </option>
                <option value="6"<?php if ($moisLimiteStage === "06") {
                    echo 'selected="selected"';
                } ?>>Juin
                </option>
                <option value="7"<?php if ($moisLimiteStage === "07") {
                    echo 'selected="selected"';
                } ?>>Juillet
                </option>
                <option value="8"<?php if ($moisLimiteStage === "08") {
                    echo 'selected="selected"';
                } ?>>Août
                </option>
                <option value="9"<?php if ($moisLimiteStage === "09") {
                    echo 'selected="selected"';
                } ?>>Septembre
                </option>
                <option value="10"<?php if ($moisLimiteStage === "10") {
                    echo 'selected="selected"';
                } ?>>Octobre
                </option>
                <option value="11"<?php if ($moisLimiteStage === "11") {
                    echo 'selected="selected"';
                } ?>>Novembre
                </option>
                <option value="12"<?php if ($moisLimiteStage === "12") {
                    echo 'selected="selected"';
                } ?>>Décembre
                </option>
            </select>
            ...
            <select name="typeStage">
                <option <?php if ($typeStage === "Stage L2") {
                    echo 'selected="selected"';
                } ?>>Stage L2
                </option>
                <option <?php if ($typeStage === "Stage L3") {
                    echo 'selected="selected"';
                } ?>>Stage L3
                </option>
                <option <?php if ($typeStage === "Projet Tuteuré") {
                    echo 'selected="selected"';
                } ?>>Projet Tuteuré
                </option>
            </select>
