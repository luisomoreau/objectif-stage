...
<?php
    email($mail_account, $mail_pwd, 'stages@univ-nc.nc', 'Objectif stage : '.$_POST['nomEnt'].' est en attente de validation',
        'Bonjour,<br>L\'entreprise '.$_POST['nomEnt'].' est en attente de validation, veuillez vous connecter pour valider son compte.<br><br><a href="https://stages.univ-nc.nc/loginadmin">Lien vers le panel admin</a>',
